...
export class SignUpComponent implements OnInit {
  ...
  public signupFunction(): any {
    ...
    if (!this.firstName) {
      ...
      this.toastr.warning('Select your country')
    }
      ...
      if (this.isAdmin == true) { this.userName = `${this.firstName}-admin` } else {
        this.userName = `${this.firstName}-user`
      }



      let ccode = `${this.ce}-${this.mobileNumber}`
      let data = {
